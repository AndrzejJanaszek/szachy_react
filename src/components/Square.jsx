...
export default function Square({color, piece, isPossibleSquare, onSquareClick, isPromotion,colorOnMove}) {
    ...
    return (
        <div className={'square '+colorClass+moveSquareClass} onClick={onClick}>
            {promotionBox}
            {genPieceIfExist()}
        </div>
    )
